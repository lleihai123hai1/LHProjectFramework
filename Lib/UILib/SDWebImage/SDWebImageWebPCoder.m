...
#import <webp/mux.h>
#else
#import "webp/webp/decode.h"
#import "webp/webp/encode.h"
#import "webp/webp/demux.h"
#import "webp/webp/mux.h"
#endif
...
- (BOOL)isAnimateWebPData:(NSData *)data {
...
//        NSLog(@"(是否主线程:%@)webp decoded time: %f",@([NSThread isMainThread]),CFAbsoluteTimeGetCurrent() - start);
        return staticImage;
    }
